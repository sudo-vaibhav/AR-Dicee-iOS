...
//  ARDicee
//
//  Created by Vaibhav Chopra on 15/12/20.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func roll(dice: SCNNode){
        ...
        dice.runAction(SCNAction.rotateBy(x: CGFloat(randomX), y: 0.0, z: CGFloat(randomZ), duration: 0.5))
    }
    ...
    func addDice(atLocation location: ARHitTestResult){
        ...
        if let diceNode =
            ...
            diceScene.rootNode.childNode(withName: "Dice", recursively: true){
